...
public class WebUtils {
    public static final String CHROME_DRIVER_PATH = "/Users/suntianci/Downloads/chromedriver-mac-x64/chromedriver";


    private static final Integer DEFAULT_TIMEOUT = 60;

    private static WebDriver createWebDriver() throws Exception {
        return createChromeWebDriver(CHROME_DRIVER_PATH);
    }
    ...
    public static void main(String[] args) throws Exception {
        screenShot2File("http://localhost:8080/#/pornMovie","/Users/suntianci/Downloads",-1);
    }
